    ...
    const caseStudyData = {
        ...
        processSections: [
            ...
            },
            {
                ...
                content: "We designed and launched a mobile-first website for Code and Coffee. The site prioritized clarity and ease of use, featuring straightforward event information, integrated RSVP functionality, and detailed directions to venues with clear access instructions. Recognizing that many attendees would be checking details on the go, the responsive layout was optimized for mobile devices, ensuring users could quickly find essential information anytime, anywhere. \n\nThe project followed a collaborative and iterative workflow starting with wireframes and interactive prototypes created in Figma. These designs were handed off to developers via GitHub issues, facilitating clear communication and tracking. Throughout development, accessibility and responsive design were key priorities, ensuring the site was inclusive and functional across devices. The site was deployed on Netlify with continuous integration from GitHub, allowing seamless updates and maintenance.",
